...
/* ── Menu Data ────────────────────────────────────────── */
const MENU_ITEMS = [
  { title: 'Amber Roast Chicken Salad', ingredients: 'Chicken, sweet potato, capsicum(green and yellow), purple cabbage, corn, lettuce, cherry tomato, english cucumber, pomegranate, peanut, cheese', dressing: 'Lemon Mustard Vinaigrette', calories: '300 kcal', price: '220', src: '/zalada/menu/DSC02327.JPG.jpeg' },
  { title: 'BBQ Chicken Harvest Bowl', ingredients: 'BBQ Chicken, herbed carrots, capsicum(green and yellow), purple cabbage, corn, lettuce, cherry tomato, english cucumber, spring onion, sesame seeds, pomegranate, peanut, cheese', dressing: 'Lemon Mustard Vinaigrette', calories: '300 kcal', price: '225', src: '/zalada/menu/DSC02320.JPG.jpeg' },
  { title: 'Orange Zest Chicken Bowl', ingredients: 'Chicken, sweet potato, capsicum(green and yellow), purple cabbage, corn, lettuce, cherry tomato, english cucumber, pomegranate, peanuts, orange slice', dressing: 'Orange Vinaigrette', calories: '300 kcal', price: '225', src: '/zalada/menu/DSC02264.JPG.jpeg' },
  { title: 'Citrus Chicken Rice Bowl', ingredients: 'Chicken, brown rice, chickpeas, capsicum(green and yellow), purple cabbage, corn, lettuce, cherry tomato, english cucumber, peanuts, orange slice, parsley', dressing: 'Orange Vinaigrette', calories: '300 kcal', price: '225', src: '/zalada/menu/citrus_chicken_rice_bowl.png' },
  { title: 'Seoul Fusion Chicken Bowl', ingredients: 'Chicken, noodles, capsicum(green and yellow), purple cabbage, corn, lettuce, cherry tomato, english cucumber, spring onion, sesame seeds, apple, peanuts, cheese', dressing: 'Thai Dressing', calories: '300 kcal', price: '225', src: '/zalada/menu/seoul_fusion_chicken_bowl.png' },
  { title: 'Chicken Pasta Bowl', ingredients: 'Chicken, pasta, capsicum(green and yellow), purple cabbage, corn, lettuce, cherry tomato, english cucumber, apple, peanuts, cheese', dressing: 'Green Goddess Dressing', calories: '300 kcal', price: '220', src: '/zalada/menu/chicken_pasta_bowl.png' },
  { title: 'Protein Packed Paneer Bowl', ingredients: 'Paneer, chickpeas, capsicum(green and yellow), purple cabbage, corn, lettuce, cherry tomato, english cucumber, apple, peanut, cheese', dressing: 'Chipotle Sauce', calories: '300 kcal', price: '215', src: '/zalada/menu/protein_packed_paneer_bowl.png' },
  { title: 'Roasted Paneer & Sweet Potato Bowl', ingredients: 'Paneer, sweet potato, capsicum(green and yellow), purple cabbage, corn, lettuce, cherry tomato, english cucumber, apple, peanut, cheese', dressing: 'Chipotle Sauce', calories: '300 kcal', price: '215', src: '/zalada/menu/roasted_paneer_sweet_potato_bowl.png' },
  { title: 'Soya Sweet Potato Duo', ingredients: 'Glazed soya chunks, sweet potato, capsicum(green and yellow), purple cabbage, corn, lettuce, cherry tomato, english cucumber, sesame seeds, apple, cheese', dressing: 'Chilli Lime', calories: '300 kcal', price: '210', src: '/zalada/menu/soya_sweet_potato_duo.png' },
]
